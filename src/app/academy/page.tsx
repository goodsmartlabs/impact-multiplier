    ...
    <div className="mx-auto max-w-6xl px-4 pb-20 pt-7 md:px-6 md:pt-12">
      <header className="mb-9 flex flex-col justify-between gap-5 md:flex-row md:items-end">
        <div className="max-w-3xl">
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-pink">CraftFools Academia</p>
...
function CoursesLanding() {
  ...
  return <>
    ...
    <CourseShelf title="More Flagship Programs" eyebrow="Original CraftFools Academia courses" courses={otherFlagships} href="/academy?view=all" columns="four" />
