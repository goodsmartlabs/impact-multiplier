  ...
  return (
    <>
      <div className="mb-7 max-w-2xl">
        ...
        <h1 className="mt-2 font-display text-4xl font-semibold leading-none text-ink">Talk to Impact Academia</h1>
